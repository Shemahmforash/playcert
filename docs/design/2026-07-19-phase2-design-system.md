...
- Warm palette vs Appendix B4: B4 specifies neutral canvas #0E0E11 / text #F2EFE9 as 'binding', but the brief explicitly forbids the near-black default and all three directions warm it. This system uses bitumen #16120D etc. as an intentional, brief-mandated departure — confirm B4's palette line is superseded (the weekday accent cycle and 11px/4.5:1 floors from B4 are retained unchanged).
