...
Phases 0–3 shipped and are LIVE (earshot-one.vercel.app). Since then the product took several deliberate turns. **Where this note conflicts with the text below, this note wins.**
